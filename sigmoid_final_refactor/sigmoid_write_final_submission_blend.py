...
def main():
    ...
    valid_session_ids = read_pickle(path=f'{CACHE_DIR}/test_final_session_ids.pkl')
    ...
    for filename in tqdm([
        f'{SUBMISSION_DIR}/{args.model_name}_v1_final_predictions.npy',
        f'{SUBMISSION_DIR}/{args.model_name}_v2_final_predictions.npy',
        f'{SUBMISSION_DIR}/{args.model_name}_v3_final_predictions.npy',
        f'{SUBMISSION_DIR}/{args.model_name}_v4_final_predictions.npy',
        f'{SUBMISSION_DIR}/{args.model_name}_v5_final_predictions.npy',
    ]):
    ...
    with open(f'{SUBMISSION_DIR}/{args.model_name}_final_score.csv', 'w') as file_out:
