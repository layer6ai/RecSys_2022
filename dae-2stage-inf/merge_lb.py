...
model_1 = pd.read_csv('./lb_dae_model_knnscores.csv')
model_1.rename(columns={'score': 'score1'}, inplace=True)
model_2 = pd.read_csv('./lb_dae_modelscores.csv')
...
model_1_second_stage = pd.read_csv('./lb_dae_model_knn_iind.csv')
model_2_second_stage = pd.read_csv('./lb_dae_model_iind.csv')
...
score_csv.to_csv('./jianing_lb_scores.csv', header=True, index=False)
